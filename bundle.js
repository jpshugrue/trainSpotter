...
function populateMap(htmlMap) {
  const map = new __WEBPACK_IMPORTED_MODULE_0__map__["default"](htmlMap);
  Object(__WEBPACK_IMPORTED_MODULE_1__routes__["a" /* getTrains */])((trains) => {
...
window.getTrains = __WEBPACK_IMPORTED_MODULE_1__routes__["a" /* getTrains */];
...
/* unused harmony export generateRoutes */


const generateSequences = (callback) => {
  $.ajax({
...
/* unused harmony export generateSequences */
...
/* harmony export (immutable) */ __webpack_exports__["a"] = getTrains;
